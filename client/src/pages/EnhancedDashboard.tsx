            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                <Badge variant="secondary" className="bg-green-100 text-green-800 border-green-200 animate-pulse">
                  ...
                  Live Trading: ${(tradingData as any)?.accountBalance?.toLocaleString() || (tradingData as any)?.metrics?.accountBalance?.toLocaleString() || '0.00'}
                </Badge>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-3xl font-bold text-gray-900 dark:text-white">
                      ${(tradingData as any)?.accountBalance?.toLocaleString() || (tradingData as any)?.metrics?.accountBalance?.toLocaleString() || '0.00'}
                    </div>
